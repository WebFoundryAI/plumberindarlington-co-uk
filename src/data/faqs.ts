...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/edinburgh/" class="text-primary hover:underline">Edinburgh</a> and the Lothians. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/edinburgh/" class="text-primary hover:underline">Edinburgh</a> and the Lothians, including <a href="/locations/leith/" class="text-primary hover:underline">Leith</a>, <a href="/locations/musselburgh/" class="text-primary hover:underline">Musselburgh</a>, <a href="/locations/dalkeith/" class="text-primary hover:underline">Dalkeith</a>, Livingston, Corstorphine, Morningside, Portobello, and Bonnyrigg. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
