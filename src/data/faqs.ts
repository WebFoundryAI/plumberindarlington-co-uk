...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/darlington/" class="text-primary hover:underline">Darlington</a> and County Durham. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/darlington/" class="text-primary hover:underline">Darlington</a> and County Durham, including <a href="/locations/newton-aycliffe/" class="text-primary hover:underline">Newton Aycliffe</a>, <a href="/locations/bishop-auckland/" class="text-primary hover:underline">Bishop Auckland</a>, <a href="/locations/richmond/" class="text-primary hover:underline">Richmond</a>, Northallerton, Catterick, Sedgefield, Barnard Castle, and Shildon. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
